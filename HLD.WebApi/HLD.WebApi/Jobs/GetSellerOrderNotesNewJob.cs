...
{
    public class GetSellerOrderNotesNewJob
    {
        ...
        OrderNotesDataAccessNew orderNotes = null;
        GetChannelCredViewModel _getChannelCredViewModel = null;
        public GetSellerOrderNotesNewJob(IConnectionString connectionString)
        {
            _connectionString = connectionString;
            _sellerCloudOrderDataAccess = new SellerCloudOrderDataAccessNew(_connectionString);
            orderNotes = new OrderNotesDataAccessNew(_connectionString);
