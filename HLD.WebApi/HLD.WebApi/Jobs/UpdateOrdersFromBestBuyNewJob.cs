...
namespace HLD.WebApi.Jobs
{
    ...
    public class UpdateOrdersFromBestBuyNewJob : IJob
    {
        ...
        BestBuyOrderFromBBDataAccessNew _bestBuytDataAccess = null;
        ...
        public UpdateOrdersFromBestBuyNewJob(IConnectionString connectionString)
        {
            _connectionString = connectionString;

            _EncDecChannel = new EncDecChannel(_connectionString);
            _bestBuytDataAccess = new BestBuyOrderFromBBDataAccessNew(_connectionString);
            _EncDecChannel = new EncDecChannel(_connectionString);
