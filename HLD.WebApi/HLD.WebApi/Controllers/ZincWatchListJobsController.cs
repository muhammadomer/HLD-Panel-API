...
{
    public class ZincWatchListJobsController : Controller
    {
        // GET: /<controller>/
        ...
        public ZincWatchListJobsController(IConnectionString connectionString)
        {
        ...
        [Route("api/ZincWatchListJobs")]
        public IActionResult Task()
        {
            Thread emailThread = new Thread(() => TaskExecute());
            emailThread.Start();
            return Ok(0);
        }

        public IActionResult TaskExecute()
        {
            int num = 1;
